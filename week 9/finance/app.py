...
def index():
    ...
    return render_template("index.html", stocks=stocks, cash=round(cash, 2), total_value=round(total_value, 2), grant_total=grand_total)
...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("Please enter a positive integer for the number of shares")
